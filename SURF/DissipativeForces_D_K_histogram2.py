...
# fit params from the original least squares optmizatin
...
def get_sample_K_value(parameter):
    """
    param parameter:
    i, sample

    param i: index of sample
    param sample: sample parameters
    """
    i, sample = parameter
...
plt.savefig('K_value_histogram2.png', fmt='png')
